...
NOTE: Para ver qué espacios de tablas y archivos de datos se incluyen en una copia de seguridad, utilice la `backup show command` O la ventana Propiedades de copia de seguridad.
