...
---
= El comando smsap profile verify
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puede ejecutar el `profile verify` comando para verificar la configuración del perfil. Debe montar la base de datos antes de ejecutar este comando.
